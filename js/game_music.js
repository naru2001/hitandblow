function upVolume() {
    ...
    sound5.volume = Math.min(1.0, sound5.volume + 0.1);
    sound6.volume = Math.min(1.0, sound6.volume + 0.1);
...
function downVolume() {
    ...
    sound5.volume = Math.max(0.0, sound5.volume - 0.1);
    sound6.volume = Math.max(0.0, sound6.volume - 0.1);
    sound3.currentTime = 0;
    sound3.play();
    console.log(bgm1.volume);
}
